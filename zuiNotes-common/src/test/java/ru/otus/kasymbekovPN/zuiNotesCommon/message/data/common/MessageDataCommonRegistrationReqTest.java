...
public class MessageDataCommonRegistrationReqTest {

    @Test
    @DisplayName("The testing of instance to json-like conversion")
    void objectToJson() throws JsonProcessingException {
        Boolean registration = true;
        MessageData md = new MessageDataCommonRegistrationReq(registration);
    ...
    void jsonToObject() throws IOException {
        ...
        MessageData md = (MessageData) new ObjectMapper().readerFor(MessageDataCommonRegistrationReq.class).readValue(json);
        log.info("instance : {}", md);

        assertThat(new MessageDataCommonRegistrationReq(registration)).isEqualTo(md);
    }
    ...
    void jsonToObject1() throws IOException {
        ...
        assertThat(new MessageDataCommonRegistrationReq(null)).isEqualTo(md);
    }
